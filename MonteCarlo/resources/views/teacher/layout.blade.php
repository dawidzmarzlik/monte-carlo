        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('teacher.schedule') }}">Harmonogram</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('teacher.student') }}">Kursanci</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('teacher.info') }}">Moje dane</a>
                    </li>
                </ul>
                <ul class="navbar-nav">
