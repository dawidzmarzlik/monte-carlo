            ...
            <div class="row">
                ...
                <div class="col-md-8 col-lg-6 text-center">
                    <div class="container person-container rounded-4 px-5">
                        <h3 class="white" style="font-weight: bold;">Podziel się z nami swoją opinią na temat instruktora: {{ $teacher->name }} {{ $teacher->surname }}</h3>
                        <form action="{{ route('student.review_teacher_store') }}" method="post">
                            @csrf
