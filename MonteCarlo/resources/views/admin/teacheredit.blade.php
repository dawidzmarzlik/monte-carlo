            ...
            <div class="col-md-6 col-lg-4 align-self-center justify-content-center bg-white rounded-4 p-4">
                <form method="POST" action="{{ route('teacher.update', $teacher->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        value="{{ old('surname') != '' ? old('surname') : $teacher->surname}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" onfocus="(this.type='date')" onlo class="form-control" id="birthDate"
                            name="birthDate" placeholder="Data urodzenia" value="{{ old('birthDate') != '' ? old('birthDate') : $teacher->birthDate}}">
                        {!! $errors->first('birthDate', "<span class='text-danger'>:message</span>") !!}
                    </div>

                    <div class="form-group">
                        <label for="name"></label>
                        <input type="number" class="form-control no-arrow" id="phoneNumber" name="phoneNumber"
                            placeholder="Numer telefonu" max="999999999"
                            oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                            maxlength="9" value="{{ old('phoneNumber') != '' ? old('phoneNumber') : $teacher->phoneNumber}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="password" name="password" placeholder="Hasło" value="{{ old('password') != '' ? old('password') : $teacher->password}}">
